(function(){
  ...
  function applySurvey(survey){
    if(!survey?.active||!document.querySelector('.hero'))return;const storageKey=`peyzajder-survey-closed-${survey.id}`;if(sessionStorage.getItem(storageKey))return;
