...
schemas.invitations=[F.title,['audience','Alıcı grubu','select','Tümü,Bireysel & Öğrenci,Bireysel,Öğrenci,Kurumsal'],F.date,['location','Yer / bağlantı','text'],['message','Davetiye metni','textarea'],F.status];
...
const moduleAdminMeta={
  ...
  jobPosts:{area:'FIRSATLAR / \u0130\u015e \u0130LANLARI',title:'Sekt\u00f6rel i\u015f ve staj ilanlar\u0131',desc:'Peyzaj mimarl\u0131\u011f\u0131 ve sekt\u00f6r profesyonellerine y\u00f6nelik f\u0131rsat ilanlar\u0131 bu alandan yay\u0131nlan\u0131r.',steps:['Son ba\u015fvuru tarihini girin','Ba\u015fvuru linkini kontrol edin','S\u00fcresi dolan ilanlar\u0131 ar\u015five al\u0131n'],related:['content','firms'],preview:'archive.html?type=jobs'},
