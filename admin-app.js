...
menus:['Menü yönetimi','YERLEŞİM','≡'],sliders:['Slaytlar','YERLEŞİM','▱'],promoPanels:['Yarışma panosu','YERLEŞİM','◂'],socialLinks:['Sosyal medya','YERLEŞİM','⌁'],sponsors:['Sponsor / reklam alanları','YERLEŞİM','★'],sponsorCategories:['Sponsor kategorileri','YERLEŞİM','◆'],jobPosts:['İş ilanları','FIRSATLAR','↗'],jobApplications:['İş başvuruları','FIRSATLAR','✎'],bankAccounts:['Hesap numaraları','AYARLAR','₺'],settings:['Site ayarları','AYARLAR','⚙'],users:['Yetkililer','AYARLAR','♜'],modules:['Modüller','AYARLAR','◈']};
...
$('#loginForm').onsubmit=async e=>{e.preventDefault();try{const result=await api('login',{method:'POST',body:JSON.stringify(Object.fromEntries(new FormData(e.target)))});currentRole=result.role||'admin';showApp()}catch(x){$('#loginError').textContent=x.message}};$('#logout').onclick=async()=>{await api('logout');location.href='uye-girisi.html'};$('#nav').onclick=e=>{const b=e.target.closest('[data-view]');if(b)openView(b.dataset.view)};
...
const contentViews={
  news:{category:'haberler',singular:'Haber',area:'ANA SAYFA / G\u00dcNDEM / HABERLER',title:'Haberleri y\u00f6netin',desc:'Ana sayfadaki Haberler kutusu, G\u00fcndem slayt\u0131 ve haber sayfas\u0131 bu kay\u0131tlardan beslenir. Haber; duyuru veya etkinlikle kar\u0131\u015fmaz.',preview:'haberler.html'},
  notices:{category:'duyurular',singular:'Duyuru',area:'ANA SAYFA / G\u00dcNDEM / DUYURULAR',title:'Duyurular\u0131 y\u00f6netin',desc:'Ana sayfadaki Duyurular kutusu ve duyuru sayfas\u0131 bu kay\u0131tlardan beslenir. Duyurular otomatik g\u00fcndem slayt\u0131na girmez.',preview:'duyurular.html'}
};
...
const moduleAdminMeta={
  ...
  boards:{area:'KURUMSAL / KURULLAR',title:'Y\u00f6netim ve di\u011fer kurullar',desc:'Y\u00f6netim kurulu, denetleme kurulu ve ihtiya\u00e7 halinde eklenecek t\u00fcm kurullar burada tutulur. S\u0131ralama alan\u0131 sitedeki dizilimi belirler.',steps:['Kurul ad\u0131n\u0131 ayn\u0131 yaz\u0131mla girin','Ba\u015fkan, yard\u0131mc\u0131, sekreter, sayman s\u0131ralamas\u0131 i\u00e7in order kullan\u0131n','Foto\u011fraf yoksa sistem bo\u015f profil g\u00f6rseli kullan\u0131r'],related:['content','menus'],preview:'kurullar.html'},
  firms:{area:'F\u0130RMA REHBER\u0130',title:'\u00dcye firma rehberini y\u00f6netin',desc:'Derne\u011fe \u00fcye firmalar\u0131n g\u00f6r\u00fcn\u00fcrl\u00fc\u011f\u00fc ve firma bulucu mant\u0131\u011f\u0131 bu mod\u00fclden beslenir.',steps:['\u015eehir ve uzmanl\u0131k bilgilerini dolu tutun','Web sitesi varsa mutlaka ekleyin','Aktif firmalar rehberde g\u00f6r\u00fcn\u00fcr'],related:['members','sponsors'],preview:'index.html#rehber'},
  sponsors:{area:'SPONSOR / REKLAM',title:'Sponsor logo ve reklam alanlar\u0131',desc:'Yar\u0131\u015fma sayfas\u0131ndaki Ana Sponsor, Platin, Alt\u0131n, G\u00fcm\u00fc\u015f gibi sponsor kategorileri ve genel reklam logolar\u0131 buradan y\u00f6netilir.',steps:['Yar\u0131\u015fma sayfas\u0131nda g\u00f6r\u00fcnmesi i\u00e7in Yerle\u015fim alan\u0131n\u0131 Yar\u0131\u015fma Sayfas\u0131 se\u00e7in','Sponsor kategorisini Ana Sponsor, Platin, Alt\u0131n, G\u00fcm\u00fc\u015f vb. belirleyin','Logo WebP olarak y\u00fcklenir; web adresi yeni sekmede a\u00e7\u0131l\u0131r'],related:['promoPanels','firms','settings'],preview:'yarismalar.html'},
  sponsorCategories:{area:'SPONSOR / KATEGOR\u0130LER',title:'Sponsor kategorilerini y\u00f6netin',desc:'Ana Sponsor, Platin Sponsor, Alt\u0131n Sponsor, G\u00fcm\u00fc\u015f Sponsor gibi ba\u015fl\u0131klar\u0131 buradan ekleyip s\u0131ralayabilirsiniz. Sponsor kayd\u0131ndaki kategori alan\u0131 bu ba\u015fl\u0131klarla ayn\u0131 yaz\u0131lmal\u0131d\u0131r.',steps:['Kategori ad\u0131n\u0131 net yaz\u0131n','S\u0131ra alan\u0131 sayfadaki g\u00f6r\u00fcn\u00fcm \u00f6nceli\u011fini belirler','Pasif kategoriler public sayfada ba\u015fl\u0131k olarak kullan\u0131lmaz'],related:['sponsors','promoPanels'],preview:'yarismalar.html'},
  jobPosts:{area:'FIRSATLAR / \u0130\u015e \u0130LANLARI',title:'Sekt\u00f6rel i\u015f ve staj ilanlar\u0131',desc:'Peyzaj mimarl\u0131\u011f\u0131 ve sekt\u00f6r profesyonellerine y\u00f6nelik f\u0131rsat ilanlar\u0131 bu alandan yay\u0131nlan\u0131r.',steps:['Son ba\u015fvuru tarihini girin','Ba\u015fvuru linkini kontrol edin','S\u00fcresi dolan ilanlar\u0131 ar\u015five al\u0131n'],related:['content','firms'],preview:'is-ilanlari.html'},
  articles:{area:'YAZARLAR / K\u00d6\u015eE YAZILARI',title:'K\u00f6\u015fe yaz\u0131lar\u0131n\u0131 onaylay\u0131n',desc:'Yazar panelinden gelen yaz\u0131lar burada d\u00fczenlenir, onaylan\u0131r ve yay\u0131na al\u0131n\u0131r.',steps:['Beklemede yaz\u0131lar\u0131 okuyup kontrol edin','Aktif yap\u0131lan yaz\u0131lar k\u00f6\u015fe yaz\u0131lar\u0131 sayfas\u0131nda g\u00f6r\u00fcn\u00fcr','Ana sayfa g\u00f6sterim biti\u015fi sadece \u00f6ne \u00e7\u0131karma i\u00e7indir'],related:['authors','users'],preview:'kose-yazilari.html'},
  authors:{area:'YAZARLAR / YAZAR PROF\u0130LLER\u0130',title:'K\u00f6\u015fe yazar\u0131 profilleri',desc:'Yazarlar\u0131n ad, e-posta, foto\u011fraf ve durum bilgileri burada tutulur. Panel kullan\u0131c\u0131s\u0131yla e-posta \u00fczerinden e\u015fle\u015fir.',steps:['Yazar\u0131n e-postas\u0131 kullan\u0131c\u0131 hesab\u0131yla ayn\u0131 olmal\u0131','Pasif yazarlar yeni yaz\u0131 g\u00f6nderememeli','Foto\u011fraf eklenirse yaz\u0131 kartlar\u0131 g\u00fc\u00e7lenir'],related:['articles','users'],preview:'kose-yazilari.html'},
  contactMessages:{area:'\u0130LET\u0130\u015e\u0130M / MESAJLAR',title:'Ziyaret\u00e7i mesajlar\u0131',desc:'\u0130leti\u015fim sayfas\u0131ndaki interaktif mesaj panelinden gelen talepler burada takip edilir.',steps:['Yeni mesajlar\u0131 Beklemede tutun','Cevaplananlar\u0131 Okundu veya Tamamland\u0131 yap\u0131n','\u00d6nemsel talepleri raporlay\u0131n'],related:['emailCampaigns','supportTickets'],preview:'iletisim.html'},
  invitations:{area:'\u0130LET\u0130\u015e\u0130M / \u00dcYE DAVET\u0130YELER\u0130',title:'Etkinlik davetiyelerini y\u00f6netin',desc:'Onayl\u0131 bireysel, \u00f6\u011frenci ve kurumsal \u00fcyelere panel i\u00e7inden g\u00f6r\u00fcnecek davetiyeler haz\u0131rlay\u0131n.',steps:['Hedef \u00fcye grubunu se\u00e7in','Etkinlik metni, tarih ve konumu girin','Aktif davetiyeler ilgili \u00fcye panellerinde g\u00f6r\u00fcn\u00fcr'],related:['events','members','memberMessages'],preview:'uye-paneli.html'},
  memberMessages:{area:'\u0130LET\u0130\u015e\u0130M / \u00dcYE MESAJLARI',title:'\u00dcyelerle mesajla\u015f\u0131n',desc:'Onayl\u0131 \u00fcyelerin panellerinden g\u00f6nderdi\u011fi mesajlar\u0131 okuyun ve do\u011frudan ayn\u0131 hesaba yan\u0131t verin.',steps:['Yeni mesajlar\u0131 listeden a\u00e7\u0131n','Yan\u0131tla ile hesap bilgilerini otomatik doldurun','Yan\u0131t \u00fcye panelindeki mesaj ge\u00e7mi\u015finde g\u00f6r\u00fcn\u00fcr'],related:['members','invitations'],preview:'uye-paneli.html'},
...
function smartDetail(view,x){
  ...
  if(view==='jobApplications')return `${x.jobTitle||'\u0130lan'} ${x.phone?'\u00b7 '+x.phone:''} ${x.documentUrl?'\u00b7 CV var':''}`;
...
async function renderSmartModule(view){
  try{
    ...
    const activeCount=items.filter(x=>['aktif','aktif \u00fcye','yay\u0131nda','\u00f6dendi','tamamland\u0131','onayland\u0131'].includes(norm(statusText(x)))).length;
...
function drawSmartRows(){
  ...
  $('#smartRows').innerHTML=rows.length?rows.map(x=>`<tr><td><b>${escapeHtml(smartTitle(x))}</b><small>${escapeHtml(smartDetail(view,x))}</small></td><td>${(view==='applications'||view==='jobApplications')&&x.documentUrl?`<a href="${escapeHtml(x.documentUrl)}" target="_blank" rel="noopener" style="color:#416b4e;font-weight:700">${view==='jobApplications'?"CV'yi aç ↗":'İmzalı formu aç ↗'}</a>`:`<span>${escapeHtml(smartCategory(view,x))}</span>`}</td><td><span class="status">${escapeHtml(statusText(x))}</span></td><td>${new Date(x.updatedAt||x.createdAt||Date.now()).toLocaleDateString('tr-TR')}</td><td><div class="row-actions">${view==='memberMessages'&&x.direction==='Üyeden yönetime'?`<button data-reply="${x.id}">Yanıtla</button>`:''}<button data-edit="${x.id}">Düzenle</button><button data-delete="${x.id}">Sil</button></div></td></tr>`).join(''):`<tr><td colspan="5" class="empty">Bu bölümde henüz kayıt yok. Sağ üstten veya bölüm içindeki “Yeni kayıt ekle” butonundan başlayabilirsiniz.</td></tr>`;
...
$('#editorForm').onsubmit=async e=>{
  ...
  if(document.querySelector('#smartRows')&&state.view!=='dues'){
    ...
    const data=Object.fromEntries(new FormData(e.target));
    try{
      const result=await api(state.edit?`${state.view}/${state.edit.id}`:state.view,{method:state.edit?'PUT':'POST',body:JSON.stringify(data)});
      $('#editor').close();
      if(result?.tempPassword)alert(`Üyenin sisteme giriş şifresi oluşturuldu:\n\n${result.tempPassword}\n\nBu şifre bir daha gösterilmeyecek, üyeye iletmeyi unutmayın.`);
